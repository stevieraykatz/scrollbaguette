...
contract BaguetteNFT is ERC721Enumerable, ReentrancyGuard, Ownable {
  string[] private BACKGROUNDS = ["#000000", "#c0392b", "#13438c"];

  string[] private SHADER1 = ["#229954", "#9b59b6", "#2e86c1"];

  string[] private SHADER2 = ["#c14fe2", "#52be80", "#d5d8dc", "#ec7063", "#4d5656"];

  string[] private SHADER3 = ["#f7ca93"];

  string[] private SHADER4 = ["#e37c19"];

  string[] private SHADER5 = ["#f09c46"];

  string[] private SHADER6 = ["#f1c40f", "#c9630d"];
